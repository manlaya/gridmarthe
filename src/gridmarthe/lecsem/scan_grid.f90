...
CONTAINS
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    !
    SUBROUTINE WRITE_GRID(XVAR, XCOL, YLIG, DXLU, DYLU, TYP_DON, TITSEM, &
        ...
        DO ISTEP=1, NSTEPS
            ...
            DO NU_GRID=1, NGRID
                ...
                DO N_COUCH=1, NLAY
                    ...
                    XTEMPVAR = XVAR(ISTEP, start_idx:end_idx)
                    XTEMPCOL = XCOL(start_idx:end_idx)      ! x is repeated for every different y, but EDSEMI_3 will subset to NKOL
                    ...
                    DXTEMP   = DXLU(start_idx:end_idx)
                    DYTEMP   = DYLU(start_idx:end_idx:NKOL) ! same here
                    !
                    ...
                    CALL EDSEMI_3(&
                        XTEMPVAR, NKOL, NLIG, XTEMPCOL, YTEMPLIG, X0, Y0, INVY &
