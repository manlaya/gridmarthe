...
* add: river network computation from legacy fortran sources #7
...
* fix: using `load_marthe_grid` with a Path object #14
* fix: bad return array with `get_active_mask` #13
* fix: order of y coordinates in stack coords #11
* fix: cleanmgrid script #10 #15
* fix: ncmart script #9
...
* fix: cleanmgrid with conda #8


## [0.2.0] - 2025-XX-Unreleased (dev version)
