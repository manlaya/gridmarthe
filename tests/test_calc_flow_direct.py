...
def test_calc_flow_direct():
    ...
    gm.write_marthe_grid(ds=ds, fileout=os.path.join(os.path.abspath(DATA_PATH), "test_write_dir_aval.d_ava"), varname='direct_aval')
    ds_read = gm.load_marthe_grid(os.path.join(os.path.abspath(DATA_PATH), "test_write_dir_aval.d_ava"))
